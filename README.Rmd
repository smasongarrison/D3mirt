...
![anesdata0809offwaves](p1.png)Figure 5: Gender profile for the `anes0809offwaves` data set, plotted rotated $15^{\circ}$ clock wise. ![anesdata0809offwaves](p2.png)Figure 6: Gender profile for the `anes0809offwaves` data set, plotted rotated $90^{\circ}$ clock wise.
...
![anesdata0809offwaves](ci1.png)Figure 7: Adults less than or equal to age 30 from the `anes0809offwaves` data set plotted surrounded by a $95\%\,CI$ and rotated $15^{\circ}$ clock wise. ![anesdata0809offwaves](ci2.png)Figure 8: Adults less than or equal to age 30 from the `anes0809offwaves` data set plotted surrounded by a $95\%\,CI$ and rotated $90^{\circ}$ clock wise.
