#' dmirt: Estimation of the D3mirt S3 Object
#'
#' @description The `dmirt()`function creates an S3 object that contains all necessary estimates for the three dimensional measurement model.
...
#'
#' @return S3 object that contain lists with estimates.
#' @export
#'
