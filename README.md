...
`mirt()` directly in the call to `D3mirt()` or a data frame containing
model parameters from the compensatory model. The `summary()` function,
included in the package, is used to inspect the DMIRT estimates. The
