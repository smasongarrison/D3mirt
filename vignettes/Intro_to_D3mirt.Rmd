...
The direction cosines are also reported in spherical coordinates ($\theta, \phi$), in which $\theta$ is the vector projection of the vector arrows in the xz-plane, and $\phi$ is the positive angle between the y-axis and the vectors (the distance $\rho$ has no meaning in the model and is set to $\rho = 1$).
