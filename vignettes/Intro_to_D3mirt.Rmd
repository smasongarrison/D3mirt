...
-   1.2 Item Selection
-   1.3 The Model Identification Procedure
-   1.4 Trouble Shooting
-   1.5 Criteria For Model Identification
-   1.6 Limitations
...
The `plot()` function is built on functions from the `rgl` package (Adler & Murdoch, 2023) for visualization with OpenGL.
