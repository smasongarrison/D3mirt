...
In this example, the S4 object `mod1` from the mirt estimation above is used directly in the call to `D3mirt()`.

```{r, include = FALSE}
load("mod1.Rdata")
mod1 <- data.frame(mirt::coef(mod1, simplify=TRUE)$'items'[,1:8])
```
```{r, eval = FALSE}
