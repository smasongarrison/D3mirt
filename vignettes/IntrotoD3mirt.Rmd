...
The items that are suggested by `modid()` to identify the model in this example are the items "W7Q3", for the $x$-axis, and "W7Q20", for the $y$-axis.
...
The `summary()` function is used to inspect the DMIRT estimates.
